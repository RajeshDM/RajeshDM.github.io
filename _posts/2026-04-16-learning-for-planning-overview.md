...
description: "A four-part series on how graph neural networks let learned policies generalize from solvable training instances to problems orders of magnitude larger — without ever retraining."
_styles: >
  .blog-fullhtml {
...
<p class="subtitle">A four-part series on how graph neural networks let learned policies generalize from solvable training instances to problems orders of magnitude larger &mdash; without ever retraining.</p>
...
<div class="pull">
    <p><strong>One unifying example.</strong> All four posts use the same toy domain &mdash; a robot delivering packages between zones in a warehouse. Each post returns to it, scaled differently. By Post 4 you've watched it grow from 4 zones and 1 package (solvable in milliseconds by a classical planner) to 100+ zones and dozens of packages (solvable in seconds by GABAR; intractable for anyone else).</p>
</div>

<h2>The roadmap</h2>

<div class="roadmap">
    <h3>Four posts, one paper, one running example</h3>

    <div class="rm-item">
        <div class="rm-num">01</div>
        <div class="rm-body">
            <div class="rm-title"><a href="/blog/2026/learning-for-planning-scaling-problem/">The Scaling Problem + the Two Axes</a> <span class="rm-tag">the problem + framing</span></div>
    ...
    <div class="rm-item">
        ...
        <div class="rm-body">
            <div class="rm-title"><a href="/blog/2026/learning-for-planning-what-to-learn/">What to Learn &mdash; Objectives Survey</a> <span class="rm-tag">survey: axis 1</span></div>
    ...
    <div class="rm-item">
        ...
        <div class="rm-body">
            <div class="rm-title"><a href="/blog/2026/learning-for-planning-state-as-graph/">Graph Representations &mdash; A Survey</a> <span class="rm-tag">survey: axis 2</span></div>
    ...
    <div class="rm-item">
        ...
        <div class="rm-body">
            <div class="rm-title"><a href="/blog/2026/learning-for-planning-gabar/">GABAR &mdash; You Don't Need to Rank All States</a> <span class="rm-tag anchor">paper deep-dive</span></div>
...
<ul>
    <li><strong>Linear (recommended for first read):</strong> 01 &rarr; 02 &rarr; 03 &rarr; 04 &rarr; 05. About 90 minutes total, including time spent on the interactive visualizations.</li>
    <li><strong>Paper-first:</strong> Skip straight to 04 (GABAR) for the paper deep-dive. The "Series context" sidebar at the top of that post points back to Posts 1-3 if you need the setup.</li>
