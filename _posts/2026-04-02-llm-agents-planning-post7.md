...
_styles: >
  ...
  html[data-theme="dark"] .blog-fullhtml .image-placeholder { background: #1a2030; border-color: #2a3545; color: #8899aa; }
  ...
  html[data-theme="dark"] .blog-fullhtml .math-block { background: #1e2530; color: #d0d8e8; }
  html[data-theme="dark"] .blog-fullhtml .credit-step { border-color: #2a3545; background: #1a2535; color: #b0b8c8; }
  ...
  html[data-theme="dark"] .blog-fullhtml .credit-step.unknown { border-color: #3a3f45; color: #9aa8b8; background: #1a2030; }
  html[data-theme="dark"] .blog-fullhtml .credit-arrow { color: #8899aa; }
  html[data-theme="dark"] .blog-fullhtml .credit-reward { color: #d0d8e8; }
  html[data-theme="dark"] .blog-fullhtml .credit-flow { color: #b0b8c8; }
  html[data-theme="dark"] .blog-fullhtml .orch-compare { color: #b0b8c8; }
  html[data-theme="dark"] .blog-fullhtml .orch-card { background: #1a2535; border-color: #2a3545; color: #b0b8c8; }
  html[data-theme="dark"] .blog-fullhtml .orch-card.prompted { background: #2a1414; border-color: #5a3030; }
  html[data-theme="dark"] .blog-fullhtml .orch-card.trained { background: #142a14; border-color: #1a6b1a; }
  ...
  html[data-theme="dark"] .blog-fullhtml .orch-card.prompted ul { color: #f0a0a0; }
  html[data-theme="dark"] .blog-fullhtml .orch-card.trained ul { color: #a0d8a0; }
  html[data-theme="dark"] .blog-fullhtml .orch-card.prompted .cost { color: #e06060; }
  html[data-theme="dark"] .blog-fullhtml .orch-card.trained .cost { color: #5cbf5c; }
  html[data-theme="dark"] .blog-fullhtml .agent-pool { background: #1e2530; border-color: #2a3545; }
  html[data-theme="dark"] .blog-fullhtml .agent-group { background: #1a2030; border-color: #2a3545; }
  html[data-theme="dark"] .blog-fullhtml .agent-group-label { color: #9aa8b8; }
  html[data-theme="dark"] .blog-fullhtml .agent-legend { color: #9aa8b8; }
  html[data-theme="dark"] .blog-fullhtml .hybrid-diagram { background: #1e2530; border-color: #2a3545; }
  html[data-theme="dark"] .blog-fullhtml .hybrid-layer { background: #1a2535; border-color: #2a3545; color: #b0b8c8; }
  html[data-theme="dark"] .blog-fullhtml .hybrid-layer.layer1 { background: #2a2010; border-color: #d4740e; }
  html[data-theme="dark"] .blog-fullhtml .hybrid-layer.layer2 { background: #142a14; border-color: #1a6b1a; }
  ...
  html[data-theme="dark"] .blog-fullhtml .hybrid-rules { color: #b0b8c8; }
  html[data-theme="dark"] .blog-fullhtml .hybrid-arrow { color: #8899aa; }
  html[data-theme="dark"] .blog-fullhtml .train-pipeline { background: #1e2530; border-color: #2a3545; }
  html[data-theme="dark"] .blog-fullhtml .train-stage { background: #1a2535; border-color: #2a3545; color: #b0b8c8; }
  ...
  html[data-theme="dark"] .blog-fullhtml .train-stage.augment { border-color: #d4740e; background: #2a2010; }
  html[data-theme="dark"] .blog-fullhtml .train-stage.augment h5 { color: #e8a040; }
  html[data-theme="dark"] .blog-fullhtml .train-stage.soft { border-color: #2a9d8f; background: #1a2a2a; }
  html[data-theme="dark"] .blog-fullhtml .train-stage.soft h5 { color: #4dd0ce; }
  ...
  html[data-theme="dark"] .blog-fullhtml .results-chart { color: #b0b8c8; }
  html[data-theme="dark"] .blog-fullhtml .results-section-label { color: #9aa8b8; }
  ...
  html[data-theme="dark"] .blog-fullhtml .results-row { color: #b0b8c8; }
  html[data-theme="dark"] .blog-fullhtml .results-value { color: #d0d8e8; }
  html[data-theme="dark"] .blog-fullhtml .demo-board { background: #1e2530; border-color: #2a3545; color: #b0b8c8; }
  html[data-theme="dark"] .blog-fullhtml .demo-col { background: #1a2535; border-color: #2a3545; }
  ...
  html[data-theme="dark"] .blog-fullhtml .demo-steps { color: #b0b8c8; }
  html[data-theme="dark"] .blog-fullhtml .demo-step { background: #1a2030; border-color: #2a3545; color: #b0b8c8; }
  ...
  html[data-theme="dark"] .blog-fullhtml .demo-status { background: #1a2030; border-color: #2a3545; color: #b0b8c8; }
  html[data-theme="dark"] .blog-fullhtml .demo-controls { color: #b0b8c8; }
  html[data-theme="dark"] .blog-fullhtml .demo-tally { background: #1a2535; color: #b0b8c8; }
